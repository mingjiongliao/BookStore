        ...
        <form id="form1" runat="server">
            ...
            <div class="rightSidePan">
                <div class="priceAndQuantityPan">
                    ...
                    <br />
                    <asp:RangeValidator ID="rngvQauntity0" runat="server" ControlToValidate="txtQauntity" CssClass="error" Display="Dynamic" ErrorMessage="Invalid" MaximumValue="10" MinimumValue="1" Type="Integer" />
                    <br />
