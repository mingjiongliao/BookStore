...
public class BookOrderListDataAccess
{
    ...
    public static void SaveABookOrder(BookOrder bookOrder)
    {
        ArrayList orders = GetAllBookOrders();
        orders.Add(bookOrder);
        SaveBookOrders(orders);
    }

    public static ArrayList GetAllBookOrders()
    {
        ...
        try
        {
            ...
            while (!sr.EndOfStream)
            {
                ...
                Book book = BookCatalogDataAccess.GetABookById(bookId);
